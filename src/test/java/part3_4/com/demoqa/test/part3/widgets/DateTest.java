...
public class DateTest extends BaseTest {
    ...
    public void testSelectingDate(){
        ...
        String expectedDate = String.format("%s/%s/%s",monthNumber,day,year);
        Assert.assertEquals(actualDate, expectedDate, String.format("Actual & expected do not match, actual date: '%s' \n" +
                "Expected date: '%s'",actualDate,expectedDate));
